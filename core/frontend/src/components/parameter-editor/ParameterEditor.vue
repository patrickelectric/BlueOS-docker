  ...
  methods: {
    ...
    saveParametersToFile() {
      ...
      const parameters = Object.values(autopilot_data.parameters).sort((first, second) => {
        if (parameter_name_max_size < first.name.length) {
          parameter_name_max_size = first.name.length
        }
        if (parameter_name_max_size < second.name.length) {
          parameter_name_max_size = second.name.length
        }
